...
function CategorySection({ categories }) {
    ...
    return <section ref={ref} className={`w-11/12 h-full  transition-all duration-700 delay-100 ${isVisible && categories ? 'opacity-1 translate-y-0' : 'opacity-0 translate-y-[100px]'}`}>
