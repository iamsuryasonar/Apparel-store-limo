...
function InstagramWrapper() {
    ...
    return <div ref={ref} className={`flex flex-col justify-center items-center p-6 transition-all duration-700 ${isVisible ? 'opacity-1 translate-y-0' : 'opacity-0 translate-y-[100px]'}`}>
