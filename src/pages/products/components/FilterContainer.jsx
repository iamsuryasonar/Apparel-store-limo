...
function FilterContainer({ setFilterContainerVisible, sortType, priceRange, activeFilters, minMaxValue, sortHandler, handleRangeChange, onDragEndHandler, removeFilterCriteria }) {
    return <div className='z-50 sm:z-0 fixed top-0 bottom-0 sm:bottom-auto left-0 sm:left-auto right-0 sm-right-auto sm:sticky sm:top-32 sm:w-full h-screen lg:w-1/3 bg-slate-50 '>
