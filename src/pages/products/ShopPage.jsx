        ...
        <>
            <div className=" max-w-7xl  w-full flex flex-col items-center ">
                ...
                <div className='sticky top-20 w-full h-12 flex bg-slate-50 items-center justify-between gap-6 z-30'>
                    ...
                    {numberOfProducts !== 'NaN' && products?.pagination?.total_products && <div className='mr-8 flex gap-1 text-lg font-semibold text-slate-500'><span>{numberOfProducts}</span><span>of</span><span> {products?.pagination?.total_products}</span></div>}
                </div>
                <div className='w-full flex lg:flex-row flex-col'>
                    {isFilterContainerVisible &&
                        <div className='sticky top-32 w-full h-screen lg:w-1/3 bg-slate-50 '>
                            <div className='sticky top-32 w-full bg-slate-50 flex flex-col p-4 gap-6 '>
                                <div>
